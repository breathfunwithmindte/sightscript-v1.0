...
module.exports = new Func({
  ...
  func_exe: async function (current, sp_state) {
    ...
    if(typeof props[0] !== "string") {
      clogs(41, 31, "[ERROR]", "First argument of function ends_with[string] should be an string.")
      return;
    }
    const oldstring = props[0];
    const endwith = props[1] === undefined ? " " : props[1]

    return oldstring.endsWith(endwith);
  } 
})