...
module.exports = class ExeMethods {
     ...
     * @doc nothing funcy simple write variable with ready value from compiler;
     */
    write_variable_object (current, scope_state)
    {
        let actual_obj = new Object();
        let newobj = {...scope_state};
        this.execute(current.obj_value, newobj);
     ...
     * @doc nothing funcy simple write variable with ready value from compiler;
     */
    write_variable_array (current, scope_state)
    {
        const variable_array = this.#write_anonumous_variable(current.arr_value, scope_state); 
    ...
    /**
     * @param {Executable[]} array_executables as
     * \d
     * as
     * das
     * d
